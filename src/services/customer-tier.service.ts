 ...
 */
const queryCustomerTiers = async (filter: {
  name?: string;
  sortBy?: string;
  sortType?: 'asc' | 'desc';
  limit?: number;
 ...
 */
const getCustomerTierById = async (tierId: number) => {
 ...
 */
const deleteCustomerTier = async (tierId: number) => {
  const tier = await prisma.customerTier.findUnique({
    where: { id: tierId },
    include: {
      _count: {
 ...
 */
const checkAndUpgradeCustomerTier = async (customerId: number) => {
 ...
 */
const batchUpgradeCustomerTiers = async () => {
...
export default {
  ...
  updateCustomerTier,
  deleteCustomerTier,
  checkAndUpgradeCustomerTier,
  batchUpgradeCustomerTiers
};
