...
- [2.2. Tổng quan các Actor](#22-tổng-quan-các-actor)
- [2.3. Use Case: Quản lý Đặt phòng (Booking)](#23-use-case-quản-lý-đặt-phòng-booking)
- [2.4. Use Case: Check-in](#24-use-case-check-in)
- [2.5. Use Case: Check-out](#25-use-case-check-out)
- [2.6. Use Case: Quản lý Người dùng](#26-use-case-quản-lý-người-dùng)
- [2.7. Ma trận phân quyền](#27-ma-trận-phân-quyền)
...
_Tài liệu này được tạo tự động từ phân tích hệ thống RoomMaster Backend_
